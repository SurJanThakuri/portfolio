...
export const projects: Project[] = [
  {
    ...
    links: [{ label: "[VIEW PROJECT]", href: "https://tiyaapp.com/" }],
    status: "LIVE IN PROD",
  ...
  },
  {
    ...
    links: [{ label: "[VIEW PROJECT]", href: "https://www.buychino.com/" }],
    status: "PRODUCTION",
  },
  {
    id: "003",
    ...
    links: [{ label: "[VIEW PROJECT]", href: "https://www.silver6nepal.com/" }],
    status: "PRODUCTION",
  },
  {
    id: "004",
    ...
    links: [{ label: "[VIEW PROJECT]", href: "https://gripastech.com/" }],
    status: "PRODUCTION",
    badge: "GSAP POWERED",
  },
  {
